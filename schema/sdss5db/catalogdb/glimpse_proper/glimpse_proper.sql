...
ALTER TABLE glimpse_proper ADD COLUMN tmass_cntr_sdss BIGINT;
UPDATE glimpse_proper a SET tmass_cntr_sdss = t.pts_key FROM twomass_psc t WHERE t.pts_key = a.tmass_cntr;
