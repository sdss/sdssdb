...
Schema for sdssSpecObj DR17 table.
(Same as schema for sdssSpecObj DR16 table.) 

Model can be found at http://skyserver.sdss.org/CasJobs/SchemaBrowser.aspx

File is /uufs/chpc.utah.edu/common/home/sdss10/sdss5/target/catalogs/sdssSpecObj
...
-- \copy catalogdb.sdss_dr17_specobj FROM program 'bzcat /uufs/chpc.utah.edu/common/home/sdss10/sdss5/target/catalogs/sdssSpecObj/dr17/src/sqlSpecObj.csv.bz2' WITH CSV HEADER;

\copy catalogdb.sdss_dr17_specobj FROM program 'bzcat /uufs/chpc.utah.edu/common/home/sdss10/sdss5/target/catalogs/sdssSpecObj/dr17/sqlSpecObj.csv.bz2' WITH CSV HEADER;

CREATE INDEX CONCURRENTLY ON catalogdb.sdss_dr17_specobj (q3c_ang2ipix(ra, dec));

ANALYZE catalogdb.sdss_dr17_specobj;

CREATE INDEX CONCURRENTLY ON catalogdb.sdss_dr17_specobj USING BTREE (fluxObjID);
CREATE INDEX CONCURRENTLY ON catalogdb.sdss_dr17_specobj USING BTREE (targetObjID);

CREATE INDEX CONCURRENTLY ON catalogdb.sdss_dr17_specobj (mjd, plate, fiberid);
CREATE INDEX CONCURRENTLY ON catalogdb.sdss_dr17_specobj (mjd, plate, fiberid, run2d);
