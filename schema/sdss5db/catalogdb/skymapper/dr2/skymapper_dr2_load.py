# Program: skymapper_dr2_load.py
# Aim: load SkyMapper.DR2.master.part*.csv files into the postgreSQL sdss5db database.
#
...
csv_dir = "/uufs/chpc.utah.edu/common/home/sdss50/sdsswork/target/catalogs/skymapper/dr2/"  # noqa E501
csvout_dir = "/uufs/chpc.utah.edu/common/home/sdss50/sdsswork/target/catalogs/skymapper/dr2csvout/"  # noqa E501

list_of_csv_files = glob.glob(csv_dir + "SkyMapper.DR2.master.part*.csv")
list_of_csv_files.sort()

fout = open(csvout_dir + "load.csv.out", "a")

if DEBUG is True:
    list_of_csv_files = [csv_dir + "SkyMapper.DR2.master.part0001.csv"]
