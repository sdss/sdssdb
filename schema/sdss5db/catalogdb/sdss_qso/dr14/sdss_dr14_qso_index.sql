...
CREATE INDEX CONCURRENTLY ON catalogdb.sdss_dr14_qso (mjd, plate, fiberid);

-- CREATE INDEX CONCURRENTLY ON catalogdb.sdss_dr14_qso (specobjid);

CREATE INDEX CONCURRENTLY ON catalogdb.sdss_dr14_qso (q3c_ang2ipix(ra, dec));
