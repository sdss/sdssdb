...
input_dir = '/uufs/chpc.utah.edu/common/home/sdss50/sdsswork/target/catalogs/sdss_dr17_apogee/'  # noqa: E501
...
for input_fits_file in input_fits_file_list:
    ...
    for line in fin:
        ...
        line = line.replace('], dtype=int32)', ',}')
        line = line.replace('],dtype=float64)', ',}')
        line = line.replace('], dtype=float64)', ',}')
        line = line.replace('],dtype=int64)', ',}')
        line = line.replace('], dtype=int64)', ',}')
        line = line.replace(', ', ',')
