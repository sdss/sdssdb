...
input_dir = '/uufs/chpc.utah.edu/common/home/sdss50/sdsswork/target/catalogs/lamost_dr6/'
input_file = 'dr6_v2_LRS_xGEDR3_SID.fits'
...
for line in fin:
    ...
    line = line.lstrip('(')
    line = line.rstrip(')')
    # replace single quote by double quote so the output CSV file can be
    # loaded by the psql \copy command option 'csv'
    line = line.replace("'", '"')
    line = line.replace(', ', ',')
