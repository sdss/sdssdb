CREATE TABLE catalogdb.deep_glimpse (
  designation TEXT,
...
ALTER TABLE deep_glimpse ADD COLUMN tmass_cntr_sdss BIGINT;
UPDATE deep_glimpse a SET tmass_cntr_sdss = t.pts_key FROM twomass_psc t WHERE t.pts_key = a.tmass_cntr;
