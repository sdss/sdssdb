...
\o legacy_survey_dr10_gaia_dr2_source_id.out

alter table catalogdb.legacy_survey_dr10 add column gaia_dr2_source_id bigint;
...
update catalogdb.legacy_survey_dr10 set gaia_dr2_source_id = ref_id
    where ref_cat = 'G2';
