...
# @Date: 2020-03-24
# @Filename: galactic_millisecond_pulsars.py
...
def main():
    ...
    file_ = os.environ['CATALOGDB_DIR'] + '/mwm_small/msp_good.fits'
    ...
    copy_data(data, database, 'galactic_millisecond_pulsars', schema='catalogdb')
