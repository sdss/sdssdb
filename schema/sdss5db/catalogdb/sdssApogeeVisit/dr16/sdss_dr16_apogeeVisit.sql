...
schema for dr16 apogeeVisit table.

Model can be found at http://skyserver.sdss.org/CasJobs/SchemaBrowser.aspx

file is /uufs/chpc.utah.edu/common/home/sdss/dr16/casload/apCSV/spectro/sqlApogeeVisit.csv.bz2
...
CREATE TABLE catalogdb.sdss_dr16_apogeeVisit(
...
\copy catalogdb.sdss_dr16_apogeeVisit FROM program 'bzcat /uufs/chpc.utah.edu/common/home/sdss50/sdsswork/target/catalogs/sdssApogeeVisit/dr16/sqlApogeeVisit.csv.bz2' WITH CSV HEADER;

CREATE INDEX ON catalogdb.sdss_dr16_apogeeVisit (q3c_ang2ipix(ra, dec));
CLUSTER sdss_dr16_apogeeVisit_q3c_ang2ipix_idx ON catalogdb.sdss_dr16_apogeeVisit;
ANALYZE catalogdb.sdss_dr16_apogeeVisit;

CREATE INDEX ON catalogdb.sdss_dr16_apogeeVisit USING BTREE (ra);
CREATE INDEX ON catalogdb.sdss_dr16_apogeeVisit USING BTREE (dec);
CREATE INDEX ON catalogdb.sdss_dr16_apogeeVisit USING BTREE (glon);
CREATE INDEX ON catalogdb.sdss_dr16_apogeeVisit USING BTREE (glat);

CREATE INDEX ON catalogdb.sdss_dr16_apogeeVisit USING BTREE (apogee_id);
