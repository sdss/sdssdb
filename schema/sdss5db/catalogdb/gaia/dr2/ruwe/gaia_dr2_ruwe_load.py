# Program: gaia_dr2_ruwe_load.py
# Aim: load gaia gaia dr2 ruwe csv files into the postgreSQL sdss5db database.
#
...
csv_dir = "/uufs/chpc.utah.edu/common/home/sdss10/sdss5/target/catalogs/gaia/dr2/ruwe/pipelines/"  # noqa E501
csvout_dir = "/uufs/chpc.utah.edu/common/home/sdss10/sdss5/target/catalogs/gaia/dr2/ruwe/pipelines/csvout/"  # noqa E501

list_of_csv_files = glob.glob(csv_dir + "Ruwe*.csv")
list_of_csv_files.sort()

fout = open(csvout_dir + "load.csv.out", "a")

if DEBUG is True:
    list_of_csv_files = [csv_dir + "Ruwe_100.csv"]
...
for i in range(len(list_of_csv_files)):
    ...
    print("\\copy catalogdb.gaia_dr2_ruwe ", file=fpgscript, end='')
    print("from '" + full_csv_file + "' ", file=fpgscript, end='')
    print(" with csv header null as 'null'; ", file=fpgscript)
