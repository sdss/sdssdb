# Program: gaia_edr3_load.py
# Aim: load gaia edr3 csv files into the postgreSQL sdss5db database.
#
...
csv_dir = "/uufs/chpc.utah.edu/common/home/sdss10/sdss5/target/catalogs/gaia/edr3/gaia_source/"  # noqa E501
csvout_dir = "/uufs/chpc.utah.edu/common/home/sdss10/sdss5/target/catalogs/gaia/edr3/gaia_source/csvout/"  # noqa E501

list_of_csv_files = glob.glob(csv_dir + "GaiaSource*.csv")
list_of_csv_files.sort()

fout = open(csvout_dir + "load.csv.out", "a")

if DEBUG is True:
    list_of_csv_files = [csv_dir + "GaiaSource_000000-003111.csv"]
...
for i in range(len(list_of_csv_files)):
    ...
    print("\\copy catalogdb.gaia_edr3_source ", file=fpgscript, end='')
