...
csv_dir = "/uufs/chpc.utah.edu/common/home/sdss50/sdsswork/target/catalogs/gaia/dr3/gaia_dr3_source/"  # noqa E501
csvout_dir = "/uufs/chpc.utah.edu/common/home/sdss50/sdsswork/target/catalogs/gaia/dr3/gaia_dr3_source/csvout/"  # noqa E501
...
for i in range(len(list_of_csv_files)):
    ...
    # We use use '1,1000d' so that the first 1000 lines are deleted
    # These deleted lines contain metadata about the file.
    # We do not delete the header line in the CSV file.
    print("sed  -e '1,1000d' " + full_csv_file + " > " + full_csv_nometa_file, file=fpgscript)
