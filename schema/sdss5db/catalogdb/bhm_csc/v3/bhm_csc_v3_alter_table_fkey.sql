...
-- column catalogdb.bhm_csc_v3(tmass_designation) is related to
-- column catalogdb.twomass_psc(designation)
--
-- However, we do not create the below foreign key since there
-- are some missing values in catalogdb.bhm_csc_v3(tmass_designation)  
--
