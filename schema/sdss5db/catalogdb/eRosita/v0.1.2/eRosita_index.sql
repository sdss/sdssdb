...
CREATE INDEX CONCURRENTLY ON catalogdb.bhm_spiders_agn_superset (q3c_ang2ipix(ero_ra, ero_dec));
...
CREATE INDEX CONCURRENTLY ON catalogdb.bhm_spiders_clusters_superset (q3c_ang2ipix(ero_ra, ero_dec));
