...
copy_cadence('dark_174x8', 'dark_174x8_2day_v2')
cadencelist.cadences['dark_174x8_2day_v2'].delta[0] = 0.0
cadencelist.cadences['dark_174x8_2day_v2'].delta_min[0] = 0.
cadencelist.cadences['dark_174x8_2day_v2'].delta_max[0] = 0.
cadencelist.cadences['dark_174x8_2day_v2'].delta[1:] = 2.0
cadencelist.cadences['dark_174x8_2day_v2'].delta_min[1:] = 1.5
cadencelist.cadences['dark_174x8_2day_v2'].delta_max[1:] = 3.5
cadencelist.cadences['dark_174x8_2day_v2'].label_root = 'dark_174x8_2day'
cadencelist.cadences['dark_174x8_2day_v2'].label_version = '_v2'
new_cadences.append('dark_174x8_2day_v2')
...
cadencelist.tocsv('rm_regular_2day.csv')

fp = open('rm_regular_2day.cfg', 'w')
cnames = list(cadencelist.cadences.keys())
cnames.sort()
for c in cnames:
