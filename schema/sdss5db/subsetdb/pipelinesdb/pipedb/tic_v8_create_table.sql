...
CREATE TABLE catalogdb.tic_v8 (
	...
	wdflag INTEGER,
	objid BIGINT,
        gaia_int BIGINT,  -- added later (not in original tic_v8 data from tess)
        twomass_psc TEXT,  -- added later
        twomass_psc_pts_key integer,  -- added later
        tycho2_tycid integer,  -- added later
        allwise_cntr bigint);   -- added later
