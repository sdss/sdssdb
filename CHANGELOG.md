...
* [#289](https://github.com/sdss/sdssdb/pull/289): Symlinking lvmopsdb to sdss5db
* [#288](https://github.com/sdss/sdssdb/pull/288): Updated vizdb schema and models for IPL-4
* [#286](https://github.com/sdss/sdssdb/pull/286): Updating catalogdb models and sql files
...
* [#275](https://github.com/sdss/sdssdb/pull/275): Update `boss_drp.json`.
* [#276](https://github.com/sdss/sdssdb/pull/276): `targetdb.targeting_generation_to_version`: add `pk`.
* [#277](https://github.com/sdss/sdssdb/pull/277): Add `sn2_15` column.
* [#278](https://github.com/sdss/sdssdb/pull/278): Tg theta 1.
* [#279](https://github.com/sdss/sdssdb/pull/279): `targetdb.targeting_generation_to_carton`: edit constraint `targeting_generation_to_carton_uniq_key`.
* [#280](https://github.com/sdss/sdssdb/pull/280): Edit `sdss_dr17_specobj*.sql` files.
...
* [#274](https://github.com/sdss/sdssdb/pull/274): Adding code to create `catalogdb.sdss_id_to_catalog` table.
* [#272](https://github.com/sdss/sdssdb/pull/272): Update tables and models for new `vizdb.sdssid_to_pipes` schema.
...
* [#264](https://github.com/sdss/sdssdb/pull/264): Add metadata for the `sdss_id_to_catalog` table.
* [#266](https://github.com/sdss/sdssdb/pull/266): Support PEP 621.
* [#268](https://github.com/sdss/sdssdb/pull/268): Allows to use `psycopy3 <https://www.psycopg.org/psycopg3/docs/>`__ as a driver for the Peewee database connection.
...
* [#127](https://github.com/sdss/sdssdb/pull/127): Add `Design.field` attribute.
...
* [#66](https://github.com/sdss/sdssdb/pull/66): Update targetdb schema with changes to cadence, carton_to_target, and others.
* Change default FK in TIC_v8 for `Tycho2`.


## 0.4.6 (2020-11-12)

* [#43](https://github.com/sdss/sdssdb/pull/43): Add a database registry
...
* [#28](https://github.com/sdss/sdssdb/pull/28) Temporarily remove SQLAlchemy implementation of `sdss5db` since it's not maintained. We may reintroduce it later once the schema is stable.
* Use `host=localhost` when a profile is being used on its own domain.
* [#32](https://github.com/sdss/sdssdb/pull/32) Assume that both SQLAlchemy and Peewee will be installed and simplify code.
...
* [#18](https://github.com/sdss/sdssdb/pull/18) Fixed Travis built after migration to using `setup.cfg`.
...
* [#13](https://github.com/sdss/sdssdb/pull/13): Add support for schema `apogeeqldb` in `operationsdb`.
* [#16](https://github.com/sdss/sdssdb/pull/16): Changed the package internals to use `setup.cfg`.
* [#14](https://github.com/sdss/sdssdb/pull/14): Add support for table `DR14Q_v4_4` in `catalogdb`.
* [#15](https://github.com/sdss/sdssdb/pull/15): New CLI `file2db` and associated tools to create and load a table from a file. Also added Numpy adaptors.
...
* Remove `bin/sdssdb` from the list of scripts to install. This was making the build process fail.


## 0.2.0 (2018-12-14)

* Removed some unused files from the template.
* [#7](https://github.com/sdss/sdssdb/pull/7): Added `~sdssdb.utils.schemadisplay.create_schema_graph` function to generate schema graphs and use it to auto-generate graphs in the documentation for the supported databases.
