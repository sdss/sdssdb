...
def define_relations():
    Quicklook.exposure = relationship(platedb.Exposure, backref="apogeeqldb_quicklooks")

    Quicklook60.quicklook = relationship(Quicklook, backref="quicklook60s")

    Quicklook60Imbinzoom.quicklook60 = relationship(Quicklook60, backref="quicklook60_imbinzooms")

    Quicklook60Repspec.quicklook60 = relationship(Quicklook60, backref="quicklook60_repspecs")

    QuicklookPrediction.quicklook = relationship(Quicklook, backref="quicklook_predictions")

    Quickred.exposure = relationship(platedb.Exposure, backref="apogeeqldb_quickreds")

    Quickred.last_quicklook = relationship(Quicklook, backref="quickreds")

    QuickredImbinzoom.quickred = relationship(Quickred, backref="quickred_imbinzooms")

    QuickredSpectrum.quickred = relationship(Quickred, backref="quickred_spectra")

    Reduction.exposure = relationship(platedb.Exposure, backref="apogeeqldb_reductions")
