...
class BossVersion(Base):
    ...
    id = Column(
        Integer,
        primary_key=True,
        server_default=text("nextval('boss_drp.boss_version_id_seq'::regclass)"),
    )
...
class BossField(Base):
    ...
    id = Column(
        Integer,
        primary_key=True,
        server_default=text("nextval('boss_drp.boss_field_id_seq'::regclass)"),
    )
...
class BossSpectrum(Base):
    ...
    id = Column(
        Integer,
        primary_key=True,
        server_default=text("nextval('boss_drp.boss_spectrum_id_seq'::regclass)"),
    )
    boss_version_id = Column(ForeignKey("boss_drp.boss_version.id"), nullable=False)
    field = Column(Integer)
    mjd = Column(Integer)
...
class BossSpectrumLine(Base):
    ...
    id = Column(
        Integer,
        primary_key=True,
        server_default=text("nextval('boss_drp.boss_spectrum_line_id_seq'::regclass)"),
    )
    boss_version_id = Column(ForeignKey("boss_drp.boss_version.id"), nullable=False)
    field = Column(Integer)
    mjd = Column(Integer)
