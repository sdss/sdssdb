...
class CalibrationStatus(Base):
    ...
    pk = Column(
        Integer,
        primary_key=True,
        server_default=text("nextval('apogee_drp.calib_status_pk_seq'::regclass)"),
    )
    logfile = Column(Text)
...
class DailyStatus(Base):
    ...
    pk = Column(
        Integer,
        primary_key=True,
        server_default=text("nextval('apogee_drp.daily_status_pk_seq'::regclass)"),
    )
    mjd = Column(Integer, index=True)
    telescope = Column(Text, index=True)
...
class Exposure(Base):
    ...
    pk = Column(
        Integer,
        primary_key=True,
        server_default=text("nextval('apogee_drp.exposure_pk_seq'::regclass)"),
    )
...
class ExposureStatus(Base):
    ...
    pk = Column(
        Integer,
        primary_key=True,
        server_default=text("nextval('apogee_drp.exposure_status_pk_seq'::regclass)"),
    )
...
class MasterCalibrationStatus(Base):
    ...
    pk = Column(
        Integer,
        primary_key=True,
        server_default=text("nextval('apogee_drp.mastercal_status_pk_seq'::regclass)"),
    )
    logfile = Column(Text)
    apred_vers = Column(Text)
    v_apred = Column(Text)
...
class Plan(Base):
    ...
    pk = Column(
        Integer,
        primary_key=True,
        server_default=text("nextval('apogee_drp.plan_pk_seq'::regclass)"),
    )
...
class RvStatus(Base):
    ...
    pk = Column(
        Integer,
        primary_key=True,
        server_default=text("nextval('apogee_drp.rv_status_pk_seq'::regclass)"),
    )
...
class RvVisit(Base):
    ...
    pk = Column(
        Integer,
        primary_key=True,
        server_default=text("nextval('apogee_drp.rv_visit_pk_seq'::regclass)"),
    )
...
class Star(Base):
    ...
    pk = Column(
        Integer,
        primary_key=True,
        server_default=text("nextval('apogee_drp.star_pk_seq'::regclass)"),
    )
    apogee_id = Column(Text, index=True)
    file = Column(Text)
    uri = Column(Text)
...
class Test(Base):
    ...
    pk = Column(
        Integer,
        primary_key=True,
        server_default=text("nextval('apogee_drp.test_pk_seq'::regclass)"),
    )
    id = Column(Text)
    version = Column(Text)
...
class Version(Base):
    ...
    pk = Column(
        Integer,
        primary_key=True,
        server_default=text("nextval('apogee_drp.version_pk_seq'::regclass)"),
    )
    name = Column(Text)
    type = Column(Text)
...
class Visit(Base):
    ...
    pk = Column(
        Integer,
        primary_key=True,
        server_default=text("nextval('apogee_drp.visit_pk_seq'::regclass)"),
    )
    apogee_id = Column(Text, index=True)
...
class VisitStatus(Base):
    ...
    pk = Column(
        Integer,
        primary_key=True,
        server_default=text("nextval('apogee_drp.visit_status_pk_seq'::regclass)"),
    )
    planfile = Column(Text)
    logfile = Column(Text)
    errfile = Column(Text)
