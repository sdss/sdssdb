...
from sqlalchemy import (ARRAY, BigInteger, Boolean, Column, DateTime, Float, Index,
...
class RvVisit(Base):
    ...
    visit_pk = Column(Integer, index=True)
    apogee_id = Column(Text, index=True)
    catalogid = Column(BigInteger)
    star_pk = Column(Integer)
    starver = Column(Text)
    file = Column(Text)
    uri = Column(Text)
