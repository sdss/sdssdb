...
class ToO_Metadata(Base):
    ...
    observe_from_mjd = Column(Integer)
...
class SDSS_ID_To_Catalog(Base):
    ...
    lead = Column(String(20))
    allstar_dr17_synspec_rev1__apstar_id = Column(String(20))
    allwise__cntr = Column(Float)
    bhm_rm_v0__pk = Column(Float)
    bhm_rm_v0_2__pk = Column(Float)
    catwise__source_id = Column(String(20))
    catwise2020__source_id = Column(String(20))
    gaia_dr2_source__source_id = Column(Float)
    gaia_dr3_source__source_id = Column(Float)
    glimpse__pk = Column(Float)
    guvcat__objid = Column(Float)
    legacy_survey_dr10__ls_id = Column(Float)
    legacy_survey_dr8__ls_id = Column(Float)
    mangatarget__mangaid = Column(String(20))
    marvels_dr11_star__starname = Column(String(20))
    marvels_dr12_star__pk = Column(Integer)
    mastar_goodstars__mangaid = Column(String(20))
    panstarrs1__catid_objid = Column(Float)
    ps1_g18__objid = Column(Float)
    sdss_dr13_photoobj__objid = Column(Float)
    sdss_dr17_specobj__specobjid = Column(String(20))
    skymapper_dr1_1__object_id = Column(Float)
    skymapper_dr2__object_id = Column(Float)
    supercosmos__objid = Column(Float)
    tic_v8__id = Column(Float)
    twomass_psc__pts_key = Column(Integer)
    tycho2__designation = Column(String(20))
