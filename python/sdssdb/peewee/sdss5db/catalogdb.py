...
from peewee import (AutoField, BigAutoField, BigIntegerField, BooleanField, CharField, DateField,
                    DecimalField, DeferredThroughModel, DoubleField, FloatField, ForeignKeyField,
...
class unWISE(SDSS5dbModel):
    ...
    x_w1 = DoubleField(null=True)
    x_w2 = DoubleField(null=True)
    y_w1 = DoubleField(null=True)
    y_w2 = DoubleField(null=True)
    flux_w1 = FloatField(null=True)
    flux_w2 = FloatField(null=True)
    dx_w1 = FloatField(null=True)
    dx_w2 = FloatField(null=True)
    dy_w1 = FloatField(null=True)
    dy_w2 = FloatField(null=True)
    dflux_w1 = FloatField(null=True)
    dflux_w2 = FloatField(null=True)
    qf_w1 = FloatField(null=True)
    qf_w2 = FloatField(null=True)
    rchi2_w1 = FloatField(null=True)
    rchi2_w2 = FloatField(null=True)
    fracflux_w1 = FloatField(null=True)
    fracflux_w2 = FloatField(null=True)
    fluxlbs_w1 = FloatField(null=True)
    fluxlbs_w2 = FloatField(null=True)
    dfluxlbs_w1 = FloatField(null=True)
    dfluxlbs_w2 = FloatField(null=True)
    fwhm_w1 = FloatField(null=True)
    fwhm_w2 = FloatField(null=True)
    spread_model_w1 = FloatField(null=True)
    spread_model_w2 = FloatField(null=True)
    dspread_model_w1 = FloatField(null=True)
    dspread_model_w2 = FloatField(null=True)
    sky_w1 = FloatField(null=True)
    sky_w2 = FloatField(null=True)
    ra12_w1 = DoubleField(null=True)
    ra12_w2 = DoubleField(null=True)
    dec12_w1 = DoubleField(null=True)
    dec12_w2 = DoubleField(null=True)
    coadd_id = TextField(null=True)
    unwise_detid_w1 = TextField(null=True)
    unwise_detid_w2 = TextField(null=True)
    nm_w1 = IntegerField(null=True)
    nm_w2 = IntegerField(null=True)
    primary12_w1 = IntegerField(null=True)
    primary12_w2 = IntegerField(null=True)
    flags_unwise_w1 = IntegerField(null=True)
    flags_unwise_w2 = IntegerField(null=True)
    flags_info_w1 = IntegerField(null=True)
    flags_info_w2 = IntegerField(null=True)
    ra = DoubleField(null=True)
    dec = DoubleField(null=True)
    primary_status = IntegerField(null=True)
...
class LegacySurveyDR8(SDSS5dbModel):
    ...
    ra = DoubleField(null=True)
    dec = DoubleField(null=True)
    ra_ivar = FloatField(null=True)
    dec_ivar = FloatField(null=True)
    dchisq = ArrayField(field_class=FloatField, null=True)
    ebv = FloatField(null=True)
    ...
    nobs_g = IntegerField(null=True)
    nobs_r = IntegerField(null=True)
    nobs_z = IntegerField(null=True)
    nobs_w1 = IntegerField(null=True)
    nobs_w2 = IntegerField(null=True)
    nobs_w3 = IntegerField(null=True)
    nobs_w4 = IntegerField(null=True)
    rchisq_g = FloatField(null=True)
    rchisq_r = FloatField(null=True)
    rchisq_z = FloatField(null=True)
    rchisq_w1 = FloatField(null=True)
    rchisq_w2 = FloatField(null=True)
    rchisq_w3 = FloatField(null=True)
    rchisq_w4 = FloatField(null=True)
    fracflux_g = FloatField(null=True)
    fracflux_r = FloatField(null=True)
    fracflux_z = FloatField(null=True)
    fracflux_w1 = FloatField(null=True)
    fracflux_w2 = FloatField(null=True)
    fracflux_w3 = FloatField(null=True)
    fracflux_w4 = FloatField(null=True)
    fracmasked_g = FloatField(null=True)
    fracmasked_r = FloatField(null=True)
    fracmasked_z = FloatField(null=True)
    fracin_g = FloatField(null=True)
    fracin_r = FloatField(null=True)
    fracin_z = FloatField(null=True)
    anymask_g = IntegerField(null=True)
    anymask_r = IntegerField(null=True)
    anymask_z = IntegerField(null=True)
    allmask_g = IntegerField(null=True)
    allmask_r = IntegerField(null=True)
    allmask_z = IntegerField(null=True)
    wisemask_w1 = SmallIntegerField(null=True)
    wisemask_w2 = SmallIntegerField(null=True)
    psfsize_g = FloatField(null=True)
    psfsize_r = FloatField(null=True)
    psfsize_z = FloatField(null=True)
    psfdepth_g = FloatField(null=True)
    psfdepth_r = FloatField(null=True)
    psfdepth_z = FloatField(null=True)
    galdepth_g = FloatField(null=True)
    galdepth_r = FloatField(null=True)
    galdepth_z = FloatField(null=True)
    psfdepth_w1 = FloatField(null=True)
    psfdepth_w2 = FloatField(null=True)
    wise_coadd_id = TextField(null=True)
    fracdev = FloatField(null=True)
    fracdev_ivar = FloatField(null=True)
    shapedev_r = FloatField(null=True)
    shapedev_r_ivar = FloatField(null=True)
    shapedev_e1 = FloatField(null=True)
    shapedev_e1_ivar = FloatField(null=True)
    shapedev_e2 = FloatField(null=True)
    shapedev_e2_ivar = FloatField(null=True)
    shapeexp_r = FloatField(null=True)
    shapeexp_r_ivar = FloatField(null=True)
    shapeexp_e1 = FloatField(null=True)
    shapeexp_e1_ivar = FloatField(null=True)
    shapeexp_e2 = FloatField(null=True)
    shapeexp_e2_ivar = FloatField(null=True)
    fiberflux_g = FloatField(null=True)
    fiberflux_r = FloatField(null=True)
    fiberflux_z = FloatField(null=True)
    ...
    ref_cat = TextField(null=True)
    ref_id = BigIntegerField(null=True)
    ref_epoch = FloatField(null=True)
    gaia_phot_g_mean_mag = FloatField(null=True)
    gaia_phot_g_mean_flux_over_error = FloatField(null=True)
    gaia_phot_bp_mean_mag = FloatField(null=True)
    gaia_phot_bp_mean_flux_over_error = FloatField(null=True)
    gaia_phot_rp_mean_mag = FloatField(null=True)
    gaia_phot_rp_mean_flux_over_error = FloatField(null=True)
    gaia_astrometric_excess_noise = FloatField(null=True)
    gaia_duplicated_source = BooleanField(null=True)
    gaia_phot_bp_rp_excess_factor = FloatField(null=True)
    gaia_astrometric_sigma5d_max = FloatField(null=True)
    gaia_astrometric_params_solved = SmallIntegerField(null=True)
    parallax = FloatField(null=True)
    parallax_ivar = FloatField(null=True)
    pmra = FloatField(null=True)
    pmra_ivar = FloatField(null=True)
    pmdec = FloatField(null=True)
    pmdec_ivar = FloatField(null=True)
...
class BhmCsc(SDSS5dbModel):
    ...
    oir_ra = DoubleField(null=True)
    oir_dec = DoubleField(null=True)
