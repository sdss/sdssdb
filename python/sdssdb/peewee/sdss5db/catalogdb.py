...
class SDSS_ID_To_Catalog(CatalogdbModel):
    ...
    mangatarget_mangaid = CharField(20)
    marvels_dr11_star_starname = CharField()
    marvels_dr12_star_pk = BigIntegerField(20)
    mangatarget_mangaid = CharField(20)
    mastar_goodstars_mangaid = BigIntegerField()
    panstarrs1_catid_objid = BigIntegerField()
    ps1_g18_objid = BigIntegerField()
    sdss_dr17_specobj_specobjid = BigIntegerField()
